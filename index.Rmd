...
- packages.bib
- rjh.bib
description: "Analysis of case studies and exercies using the tidyverse and ggplot2. This handbook was created using the bookdown package in RStudio. The output format for this example is bookdown::gitbook."
